...
// Get students by admin ID (assistantId)
function getStudentsByAdminId(adminId) {
    return Student.findAll({
        where: { assistantId: adminId, verified: true },
        attributes: ['studentId', 'studentName', 'studentEmail', 'group', 'semester']
    });
}

// Get students by DOK ID
function getStudentsByDokId(dokId) {
    return Student.findAll({
        where: { dokId: dokId, verified: true },
        attributes: ['studentId', 'studentName', 'studentEmail', 'group', 'semester']
    });
}
